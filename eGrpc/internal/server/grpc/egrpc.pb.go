...
var fileDescriptor_55f3d131f26810b9 = []byte{
	...
	0x48, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x01, 0xb1, 0x95, 0x94, 0xb9, 0xd8, 0x83,
	0x52, 0x0b, 0x4b, 0x53, 0x8b, 0x4b, 0x84, 0x24, 0xb8, 0xd8, 0x7d, 0x53, 0x8b, 0x8b, 0x13, 0xd3,
	0x53, 0x25, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0xd8, 0x73, 0x21, 0x5c, 0x25, 0x45, 0x2e, 0xd6,
	0xa0, 0xd4, 0x82, 0x9c, 0x4a, 0xdc, 0x4a, 0x8c, 0x74, 0xb9, 0x58, 0x5d, 0x41, 0x06, 0x0a, 0xa9,
	0x70, 0xb1, 0x04, 0x64, 0xe6, 0xa5, 0x0b, 0xf1, 0xea, 0x81, 0xed, 0x82, 0x1a, 0x2e, 0xc5, 0x0d,
	0xe3, 0x16, 0xe4, 0x54, 0x2a, 0x31, 0x24, 0xb1, 0x81, 0xdd, 0x60, 0x0c, 0x08, 0x00, 0x00, 0xff,
	0xff, 0xd8, 0x62, 0x07, 0x72, 0x92, 0x00, 0x00, 0x00,
}
...
func (c *egrpcClient) Ping(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Reply, error) {
	out := new(Reply)
	err := c.cc.Invoke(ctx, "/grpc.Egrpc/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
