...
func TestCreateUser(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Create user when dao do succeeded", svc: &svc, args: args{ctx: ctxb, user: user}, wantErr: false},
		{name: "Create user when dao do failed", svc: &svc, args: args{ctx: ctxb, user: user}, wantErr: true},
	}
...
func TestReadUser(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Read user when dao do succeeded", svc: &svc, args: args{ctx: ctxb, uid: user.Uid}, want: user, wantErr: false},
		{name: "Read user when dao do failed", svc: &svc, args: args{ctx: ctxb, uid: user.Uid}, want: nil, wantErr: true},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestUpdateUser(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Update user when dao do succeeded", svc: &svc, args: args{ctx: ctxb, user: user}, wantErr: false},
		{name: "Update user when dao do failed", svc: &svc, args: args{ctx: ctxb, user: user}, wantErr: true},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestDeleteUser(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "Delete user when dao do succeeded", svc: &svc, args: args{ctx: ctxb, uid: user.Uid}, wantErr: false},
		{name: "Delete user when dao do failed", svc: &svc, args: args{ctx: ctxb, uid: user.Uid}, wantErr: true},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
